...
/* SELECT  FROM `solar-router-483810-s0.homework_3.yellow_taxi_external` LIMIT 1000*/
...
-- Question 6: Question 6: Write a query to retrieve the distinct VendorIDs between tpep_dropoff_datetime 2024-03-01 and 2024-03-15 (inclusive)
